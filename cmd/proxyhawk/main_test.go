...
`
	...
	// Check number of valid proxies - 3 valid: 8.8.8.8:8080, proxy.example.com:443, socks.example.com:1080
	// 2 invalid: invalid:proxy:format + 127.0.0.1:9000 (loopback IP)
